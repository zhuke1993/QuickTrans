...
(function() {
  ...
  function formatDictionaryResult(text) {
    // 使用共享工具，但需要替换类名为content.js的样式类
    let html = DictionaryUtils.formatDictionaryResult(text);
    
    // 替换类名为content.js的命名约定
    html = html.replace(/class="dict-h5"/g, 'class="ai-translate-dict-h5"');
    html = html.replace(/class="dict-h4"/g, 'class="ai-translate-dict-h4"');
    html = html.replace(/class="dict-code"/g, 'class="ai-translate-dict-code"');
    html = html.replace(/class="dict-pos"/g, 'class="ai-translate-dict-pos"');
    html = html.replace(/class="dict-num"/g, 'class="ai-translate-dict-num"');
    html = html.replace(/class="dict-bullet"/g, 'class="ai-translate-dict-bullet"');
  ...
  function writeString(view, offset, string) {
    return DictionaryUtils.writeString(view, offset, string);
  }
